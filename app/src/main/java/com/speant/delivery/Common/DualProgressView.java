...
public class DualProgressView extends View {
    ...
    protected void init(AttributeSet attrs, int defStyle) {
        ...
        mMiddlePadding = a.getDimensionPixelSize(R.styleable.DualProgressView_dpv_middle_padding,
                resources.getDimensionPixelSize(R.dimen.default_middle_padding));
    ...
    private void setPaint() {
        ...
        mMiddleCirclePaint.setColor(mOuterCircleColor);
        mMiddleCirclePaint.setStyle(Paint.Style.STROKE);
        mMiddleCirclePaint.setStrokeWidth(mThickness);
        mMiddleCirclePaint.setStrokeCap(Paint.Cap.BUTT);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //Draw middle circle progress
        canvas.drawArc(mMiddleCircleRect, mStartAngle + mIndeterminateRotateOffset + 270f,
                mIndeterminateSweep, false, mInnerCirclePaint);
    ...
    private void updateRectAngleBounds() {
        ...
        mOuterCircleRect.set(paddingLeft + mThickness,
                paddingTop + mThickness,
                mSize - paddingLeft - mThickness,
        ...
        mMiddleCircleRect.set(paddingLeft + mThickness + mMiddlePadding,
                paddingTop + mThickness + mMiddlePadding,
                mSize - paddingLeft - mThickness - mMiddlePadding,
                mSize - paddingTop - mThickness - mMiddlePadding);
    }
